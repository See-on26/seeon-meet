...
const CONTEXT_BEFORE_REALTIME_MS = 60000;
const CONTEXT_BEFORE_DELAYED_MAX_MS = 120000;
const CONTEXT_AFTER_LISTENING_MS = 60000;
const CONTEXT_AFTER_DELAYED_MS = 8000;
...
export const CONTEXT_BEFORE_UNLIMITED_MS = Infinity;
...
export const MODE_POLICY_MAP = {
  [MODE_MAP.listening]: {
    delayMs: 60000, maxNarrationMs: 12000, rateMin: 1.0, rateMax: 1.0,
    contextAnchor: CONTEXT_ANCHOR_MAP.screenTransition,
    beforeMs: CONTEXT_BEFORE_UNLIMITED_MS, afterMs: CONTEXT_AFTER_LISTENING_MS,
    asrSegmentMs: ASR_SEGMENT_LISTENING_MS,
    isSwitchableFrom: false, isSpeculative: false, isMixed: false,
  },
  [MODE_MAP.delayed]: {
    delayMs: 10000, maxNarrationMs: 6000, rateMin: 1.1, rateMax: 1.4,
    contextAnchor: CONTEXT_ANCHOR_MAP.screenTransition,
    beforeMs: CONTEXT_BEFORE_DELAYED_MAX_MS, afterMs: CONTEXT_AFTER_DELAYED_MS,
    asrSegmentMs: ASR_SEGMENT_DELAYED_MS,
    isSwitchableFrom: false, isSpeculative: false, isMixed: false,
  },
  [MODE_MAP.realtimeScu]: {
    delayMs: 0, maxNarrationMs: 3000, rateMin: 1.5, rateMax: 1.8,
    contextAnchor: CONTEXT_ANCHOR_MAP.window,
    beforeMs: CONTEXT_BEFORE_REALTIME_MS, afterMs: CONTEXT_AFTER_REALTIME_MS,
